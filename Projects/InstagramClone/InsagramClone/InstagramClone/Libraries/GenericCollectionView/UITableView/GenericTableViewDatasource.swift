 ...
 */
open class GenericTableViewDatasource: NSObject {
     ...
     */
    open func cellClasses() -> [GenericTableViewCell.Type] {
        return []
    }
     ...
     */
    open func cellClass(_ indexPath: IndexPath) -> GenericTableViewCell.Type? {
        return nil
    }
     ...
     */
    open func headerClasses() -> [GenericTableViewCell.Type]? {
        return []
    }
     ...
     */
    open func footerClasses() -> [GenericTableViewCell.Type]? {
        return []
    }

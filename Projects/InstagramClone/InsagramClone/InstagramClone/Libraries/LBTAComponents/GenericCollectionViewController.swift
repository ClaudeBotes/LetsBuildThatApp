...
/** 
  GenericCollectionViewController is simply a UICollectionViewController that allows you to quickly create list views.
...
open class GenericCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    open var datasource: GenericCollectionViewDatasource? {
        didSet {
    ...
    override open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: GenericCollectionViewCell
        
        if let cls = datasource?.cellClass(indexPath) {
            cell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(cls), for: indexPath) as! GenericCollectionViewCell
            ...
            cell = collectionView.dequeueReusableCell(withReuseIdentifier: defaultCellId, for: indexPath) as! GenericCollectionViewCell
        }
    ...
    override open func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let reusableView: GenericCollectionViewCell
